...
<div class="modal fade" id="additionalTaskModal" tabindex="-1" aria-labelledby="additionalTaskModalLabel" aria-hidden="true"
     role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="additionalTaskForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="additionalClientName" class="form-label">Контактное лицо <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="additionalClientName" name="client_name">
                            </div>
                            <div class="col-md-6">
                                <label for="additionalClientPhone" class="form-label">Телефон <span
                                        class="text-danger">*</span></label>
                                <input type="tel" class="form-control" id="additionalClientPhone" name="client_phone">
                            </div>
                            <div class="col-md-6">
                                <label for="additionalClientOrganization" class="form-label">Организация</label>
                                <input type="text" class="form-control" id="additionalClientOrganization" name="client_organization">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 hide-me">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="additionalRequestType" class="form-label">Тип заявки <span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="additionalExecutionDate" class="form-label">Дата выполнения <span
class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="additionalExecutionDate" name="execution_date"
                                       required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="time" class="form-control" id="additionalExecutionTime" name="execution_time">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="additionalAddressesIdError" class="invalid-feedback d-none">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="my-wysiwyg">
                                ...
                                <div class="wysiwyg-toolbar btn-group mb-2" role="group" aria-label="Editor toolbar">
                                    <button type="button" class="btn btn-sm btn-outline-secondary" data-cmd="bold"
title="Жирный"><strong>B</strong></button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" data-cmd="italic"
title="Курсив"><em>I</em></button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" data-cmd="createLink" title="Вставить
ссылку">link</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" data-cmd="unlink" title="Убрать
ссылку">unlink</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" id="additionalToggleCode"
title="HTML">HTML</button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" id="additionalShowHelp"
title="Справка">
                                ...
                                <!-- Редактор HTML-кода -->
                                <textarea class="wysiwyg-code form-control mt-2" id="additionalCommentCode" rows="6" style="display:none;
"></textarea>

                                <!-- Оригинальный textarea (скрытый) -->
                                <textarea class="form-control" id="additionalComment" name="comment" rows="3"
                                        placeholder="Введите комментарий к заявке" required minlength="3"
                                        maxlength="1000" style="display:none;"></textarea>
                                <!-- Сообщение об ошибке -->
                                <div id="additionalCommentError" class="invalid-feedback d-none">
