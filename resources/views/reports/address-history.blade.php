                                ...
                                <tr>
                                    ...
                                    <td class="p-2">
                                        ...
                                        @if(isset($commentsByRequest[$request->id]) && count($commentsByRequest[$request->id]) > 0)
                                            <div class="p-1" style="max-height: 250px; overflow-y: auto; @if($typeColor) border: 5px solid {{ $typeColor }}; border-top: 0px; @else border: 1px solid #dee2e6; border-top: 0px; @endif">
                                        ...
                                        @else
                                            <div class="p-2 border rounded-bottom" style="@if($typeColor) border: 5px solid {{ $typeColor }} !important; border-top: 0px !important; @else border: 1px solid #dee2e6; border-top: 0px; @endif">
