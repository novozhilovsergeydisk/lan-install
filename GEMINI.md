...
* **Важно по шаблонам**:
  - `resources/views/welcome.blade.php`: ОСНОВНАЯ рабочая страница приложения. Все основные изменения интерфейса вносить сюда.
  - `resources/views/welcome-new.blade.php`: Вспомогательный шаблон для уведомлений через Telegram-канал. Не использовать как основную страницу.
