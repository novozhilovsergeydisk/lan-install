...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/api/requests/{id}/brigade-members', [\App\Http\Controllers\WmsIntegrationController::class, 'getRequestBrigadeMembers']);
...
Route::prefix('api/planning-types')->middleware(['auth.api', 'roles'])->group(function () {
    ...
    Route::patch('/requests/mass-subtype', [\App\Http\Controllers\PlanningRequestController::class, 'updateSubtypeMass']);
...
Route::post('/change-planning-request-status-mass', [PlanningRequestController::class, 'changePlanningRequestStatusMass'])
    ->name('change-planning-request-status-mass')
    ->middleware('auth');
