...
class HouseNumberValidator {
    ...
    validate() {
        ...
        // 1. Основной номер дома (число с необязательной буквой или дробью)
        ...
        const pattern = /^\d+[A-Za-zА-Яа-я]*(?:\/\d+[A-Za-zА-Яа-я]*)?(?:,\s*(?:корпус\s+\d+[A-Za-zА-Яа-я]*(?:,\s*строение\s+\d+[A-Za-zА-Яа-я]*)?|строение\s+\d+[A-Za-zА-Яа-я]*))?$/;
