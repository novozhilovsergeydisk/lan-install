...
class HouseNumberValidator {
    ...
    validate() {
        ...
        // 2. Необязательная часть с корпусом
        // 3. Необязательная часть со строением
        const pattern = /^\d+[A-Za-zА-Яа-я]*(?:,\s*корпус\s+\d+[A-Za-zА-Яа-я]*(?:,\s*строение\s+\d+[A-Za-zА-Яа-я]*)?)?$/;
